...
import chainlinkPng from './assets/flow.png'
...
const ImageURLS = ["https://raw.githubusercontent.com/ThisIsCodeXpert/Flow-NFT-DApp-Tutorial-Series/main/cats/cat1.svg"]
...
export default class MyGame extends Phaser.Scene {
    ...
    //       fcl.args([fcl.arg(ImageURLS, fcl.t.String)]),
    //       fcl.payer(fcl.authz),
...
const CreateNFT = () =>{
    const transactionID = fcl.send([
      fcl.transaction(createNFT),
      fcl.args([fcl.arg("https://raw.githubusercontent.com/lopeselio/img-dumps/main/trophy-18.png", fcl.t.String)]),
      fcl.payer(fcl.authz),
      fcl.proposer(fcl.authz),
      fcl.authorizations([fcl.authz]),
      fcl.limit(9999)
